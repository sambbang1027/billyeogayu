...
<header class="u-header">
	<div class="u-header__inner">
		...
		<a href="${listUrl}" class="u-logo"> <img
			src="<c:url value='/assets/layout/user/logo.svg'/>" alt="빌려가유 로고">
		</a>
		...
		<div class="u-tools">
			...
			<form class="u-search" action="${listUrl}" method="get">
				<input type="text" name="q" value="${param.q}"
					placeholder="농기계를 검색하세요." aria-label="검색">
			...
			<!-- 필터 -->
			<div class="u-filter">
				<button type="button" id="filterBtnHeader" class="u-filter__btn"
					aria-haspopup="true" aria-expanded="false">
					<span id="filterLabelHeader"> <c:out
							value="${param.filter eq 'available' ? '임대가능만' : '전체'}" />
					</span>
					<svg class="u-filter__caret" width="18" height="18"
...
<path d="M6 9l6 6 6-6" fill="none" stroke="#222" stroke-width="2" />
				...
				<div class="u-filter__menu" id="filterMenuHeader">
					<a href="${allUrl}">전체</a> <a href="${availUrl}">임대가능만</a>
				</div>
			</div>
		</div>
